    ...
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
        <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl">
          ...
          <h3 className="text-slate-100 font-semibold text-base mb-1">Local Browser Processing</h3>
          <p className="text-slate-400 text-sm">All calculations, PDF generation, and image conversions occur inside your local browser memory.</p>
        </div>
        <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl">
          <Eye className="w-6 h-6 text-emerald-400 mb-3" />
          <h3 className="text-slate-100 font-semibold text-base mb-1">Zero File Storage</h3>
          <p className="text-slate-400 text-sm">We operate zero backend databases or file storage servers. Your uploads and inputs disappear on tab close.</p>
        </div>
        <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl">
          <CheckCircle2 className="w-6 h-6 text-blue-400 mb-3" />
          <h3 className="text-slate-100 font-semibold text-base mb-1">No Sign-Up Required</h3>
          <p className="text-slate-400 text-sm">We do not collect names, emails, credit cards, or account credentials to access any of our utilities.</p>
        </div>
      </div>
      ...
      <div className="space-y-8 text-slate-300 leading-relaxed text-sm sm:text-base border-t border-slate-800/80 pt-8">
        <section>
          <h2 className="text-xl font-bold text-slate-100 mb-3">1. Information We Do Not Collect</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-slate-100 mb-3">2. Cookies and Analytics</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-slate-100 mb-3">3. Advertising Partners</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-slate-100 mb-3">4. Security</h2>
          <p>
