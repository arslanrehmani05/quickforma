  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6">
      ...
      <div className="space-y-8 text-slate-700 leading-relaxed text-sm sm:text-base border-t border-slate-200 pt-8">
        ...
        <section>
          <h2 className="text-xl font-bold text-slate-900 mb-3">2. Free Client-Side Utility Service</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-slate-900 mb-3">3. Disclaimer of Financial and Legal Advice</h2>
          <p>
