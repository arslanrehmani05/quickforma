...
import { RelatedQuestionsData } from '../../types/seo';

interface RelatedQuestionsProps {
  data?: RelatedQuestionsData;
}

export const RelatedQuestions: React.FC<RelatedQuestionsProps> = ({ data }) => {
  ...
  return (
    <section className="space-y-6">
      <div className="flex items-center gap-2 border-b border-slate-200 pb-3">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-slate-900">{data.heading || 'Expert Answers to Related Questions'}</h2>
      </div>
