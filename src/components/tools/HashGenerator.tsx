    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="p-6 sm:p-8 rounded-3xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl shadow-2xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-slate-100">Cryptographic Hash Generator</h2>
            <p className="text-slate-400 text-sm">Generate SHA-256 and SHA-512 hashes using the browser Web Crypto API.</p>
          </div>
        </div>

        <div className="space-y-4">
          <div>
            <label className="block text-slate-300 text-xs font-semibold uppercase tracking-wider mb-2">Input String</label>
            <input
              type="text"
              value={text}
