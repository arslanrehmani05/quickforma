...
export const articleSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'competingContent',
      title: 'Related / Competing Content',
      type: 'array',
      of: [{ type: 'string' }],
      fieldset: 'seoSuite',
      description: 'URLs of top ranking competitors or internal benchmarks.',
    }),
    defineField({
      name: 'targetAudience',
      ...
      options: {
        list: [
          { title: 'Small Business Owners', value: 'Small Business Owners' },
          { title: 'Freelancers & Contractors', value: 'Freelancers & Contractors' },
          { title: 'E-commerce Founders', value: 'E-commerce Founders' },
          { title: 'Legal & Tax Advisors', value: 'Legal & Tax Advisors' },
          { title: 'Developers & Tech Leads', value: 'Developers & Tech Leads' },
          { title: 'General Consumers', value: 'General Consumers' },
        ],
      },
    }),
    defineField({
      name: 'searchFunnelStage',
      title: 'Search Funnel Stage',
      type: 'string',
      fieldset: 'seoSuite',
      options: {
        list: [
          { title: 'TOFU - Top of Funnel (Awareness)', value: 'TOFU - Top of Funnel (Awareness)' },
          { title: 'MOFU - Middle of Funnel (Consideration)', value: 'MOFU - Middle of Funnel (Consideration)' },
          { title: 'BOFU - Bottom of Funnel (Conversion / Utility)', value: 'BOFU - Bottom of Funnel (Conversion / Utility)' },
        ],
      },
    }),
    defineField({
      name: 'serpFeatures',
      title: 'SERP Features / Search Features',
      type: 'array',
      of: [{ type: 'string' }],
      options: {
        list: [
          { title: 'Featured Snippet (Paragraph)', value: 'Featured Snippet (Paragraph)' },
          { title: 'Featured Snippet (Table)', value: 'Featured Snippet (Table)' },
          { title: 'Featured Snippet (List)', value: 'Featured Snippet (List)' },
          { title: 'People Also Ask (PAA)', value: 'People Also Ask (PAA)' },
          { title: 'Interactive Tool Widget', value: 'Interactive Tool Widget' },
          { title: 'Video Carousel', value: 'Video Carousel' },
          { title: 'Knowledge Panel', value: 'Knowledge Panel' },
        ],
      },
      fieldset: 'seoSuite',
    }),
    defineField({
      ...
      of: [{ type: 'string' }],
      fieldset: 'seoSuite',
      description: 'URLs or anchor texts linked inside this piece.',
    }),
    defineField({
      ...
      options: {
        list: [
          { title: 'P0 - Highest (Immediate Release)', value: 'P0 - Highest (Immediate Release)' },
          { title: 'P1 - High Priority', value: 'P1 - High Priority' },
          { title: 'P2 - Medium Priority', value: 'P2 - Medium Priority' },
          { title: 'P3 - Low / Backlog', value: 'P3 - Low / Backlog' },
        ],
      },
    }),
  ],
